<template>
    <div class="pricing-card p-8 border border-strokeColor hover:border-primary h-full rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 gap-8 justify-between flex flex-col w-full items-start relative overflow-hidden group">
        ...
        <div class="w-full pt-6 border-strokeColor border-t">
            <div class="flex items-center gap-2 mb-4">
                <Chip label="What's included" class="transform group-hover:translate-x-1 transition-transform duration-300"/>
            </div>
